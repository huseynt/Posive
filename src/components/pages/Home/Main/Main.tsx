        ...
        <div className={style.main_up}>
            ...
            >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M1.5 5.8877C1.5 4.5002 2.2425 4.3877 3.165 4.3877H14.835C15.7575 4.3877 16.5 4.5002 16.5 5.8877C16.5 7.5002 15.7575 7.3877 14.835 7.3877H3.165C2.2425 7.3877 1.5 7.5002 1.5 5.8877Z" stroke="#1A1C1E" strokeWidth="1.5" />
                    <path d="M7.32007 10.5V13.1625" stroke="#1A1C1E" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M10.77 10.5V13.1625" stroke="#1A1C1E" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M2.625 7.5L3.6825 13.98C3.9225 15.435 4.5 16.5 6.645 16.5H11.1675C13.5 16.5 13.845 15.48 14.115 14.07L15.375 7.5" stroke="#1A1C1E" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
            </button>
            <button className={style.main_up_notification}>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.01494 2.18262C6.53244 2.18262 4.51494 4.20012 4.51494 6.68262V8.85012C4.51494 9.30762 4.31994 10.0051 4.08744 10.3951L3.22494 11.8276C2.69244 12.7126 3.05994 13.6951 4.03494 14.0251C7.26744 15.1051 10.7549 15.1051 13.9874 14.0251C14.8949 13.7251 15.2924 12.6526 14.7974 11.8276L13.9349 10.3951C13.7099 10.0051 13.5149 9.30762 13.5149 8.85012V6.68262C13.5149 4.20762 11.4899 2.18262 9.01494 2.18262Z" stroke="#1A1C1E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" />
                    <path d="M10.4024 2.40008C10.1699 2.33258 9.92994 2.28008 9.68244 2.25008C8.96244 2.16008 8.27244 2.21258 7.62744 2.40008C7.84494 1.84508 8.38494 1.45508 9.01494 1.45508C9.64494 1.45508 10.1849 1.84508 10.4024 2.40008Z" stroke="#1A1C1E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M11.2649 14.2949C11.2649 15.5324 10.2524 16.5449 9.01489 16.5449C8.39989 16.5449 7.82989 16.2899 7.42489 15.8849C7.01989 15.4799 6.76489 14.9099 6.76489 14.2949" stroke="#1A1C1E" strokeWidth="1.5" strokeMiterlimit="10" />
                </svg>
            </button>
        </div>
        ...
        <div className={style.main_filter}>
            ...
            >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path style={{fill: category === 'Main Course' ? 'white' : 'black'}} d="M11.7299 1.50989L13.4899 5.02989C13.7299 5.51989 14.3699 5.98989 14.9099 6.07989L18.0999 6.60989C20.1399 6.94989 20.6199 8.42989 19.1499 9.88989L16.6699 12.3699C16.2499 12.7899 16.0199 13.5999 16.1499 14.1799L16.8599 17.2499C17.4199 19.6799 16.1299 20.6199 13.9799 19.3499L10.9899 17.5799C10.4499 17.2599 9.55991 17.2599 9.00991 17.5799L6.01991 19.3499C3.87991 20.6199 2.57991 19.6699 3.13991 17.2499L3.84991 14.1799C3.97991 13.5999 3.74991 12.7899 3.32991 12.3699L0.849909 9.88989C-0.610091 8.42989 -0.140091 6.94989 1.89991 6.60989L5.08991 6.07989C5.61991 5.98989 6.25991 5.51989 6.49991 5.02989L8.25991 1.50989C9.21991 -0.400107 10.7799 -0.400107 11.7299 1.50989Z" fill="#292D32" />
                </svg>
                <div>
                    <h4 style={{color: category === 'Main Course' ? 'white' : 'black'}}>Main Course</h4>
                    <p style={{color: category === 'Main Course' ? 'white' : 'black'}}>{meals.filter((meal) => meal.category === 'Main Course').length}</p>
                </div>
            </div>
            <div className={style.main_filter_option}
            ...
            >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_40_53719)">
                        <path style={{fill: category === 'Fast Food' ? 'white' : 'black'}} d="M15.0499 19.1668H16.4333C17.1333 19.1668 17.7083 18.6252 17.7916 17.9418L19.1666 4.2085H14.9999V0.833496H13.3583V4.2085H9.21659L9.46659 6.1585C10.8916 6.55016 12.2249 7.2585 13.0249 8.04183C14.2249 9.22516 15.0499 10.4502 15.0499 12.4502V19.1668ZM0.833252 18.3335V17.5002H13.3583V18.3335C13.3583 18.7835 12.9833 19.1668 12.4999 19.1668H1.66659C1.20825 19.1668 0.833252 18.7835 0.833252 18.3335ZM13.3583 12.5002C13.3583 5.8335 0.833252 5.8335 0.833252 12.5002H13.3583ZM0.833252 14.1668H13.3333V15.8335H0.833252V14.1668Z" fill="#1A1C1E" />
                    </g>
                    <defs>
                ...
                <div>
                    <h4 style={{color: category === 'Fast Food' ? 'white' : 'black'}}>Fast food</h4>
                    <p style={{color: category === 'Fast Food' ? 'white' : 'black'}}>{meals.filter((meal) => meal.category === 'Fast Food').length}</p>
                </div>
            </div>
            <div className={style.main_filter_option}
