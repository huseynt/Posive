      ...
      <div className={style.main}>
        ...
        <div className={style.main_filter}>
            ...
            >
                ...
                <div>
                    <h4>Main Course</h4>
                    <p>{meals.filter((meal) => meal.category === 'Main Course').length}</p>
                </div>
            </div>
            <div className={style.main_filter_option}
            ...
            >
                ...
                <div>
                    <h4>Fast food</h4>
                    <p>{meals.filter((meal) => meal.category === 'Fast Food').length}</p>
                </div>
            </div>
            <div className={style.main_filter_option}
