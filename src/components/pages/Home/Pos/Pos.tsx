      ...
      <div className={style.main}>
        ...
        <div className={style.main_filter}>
          <div
            ...
            style={{
              backgroundColor: category === "Main Course" ? "#EA7E41" : "white",
            }}
          >
            <svg
              width="20"
            ...
            >
              <path
                style={{ fill: category === "Main Course" ? "white" : "black" }}
            ...
            <div>
              <h4
                style={{
                  color: category === "Main Course" ? "white" : "black",
                }}
              >
                Main Course
              </h4>
          ...
          <div
            ...
            style={{
              backgroundColor: category === "Rice Bowl" ? "#EA7E41" : "white",
            }}
          >
            <svg
              width="20"
            ...
            >
              <path
                style={{ fill: category === "Rice Bowl" ? "white" : "black" }}
            ...
            <div>
              <h4
                style={{ color: category === "Rice Bowl" ? "white" : "black" }}
              >
                Rice Bowl
              </h4>
              <p
          ...
          <div
            ...
            style={{
              backgroundColor: category === "Fast Food" ? "#EA7E41" : "white",
            }}
          >
            <svg
              width="20"
            ...
            >
              <g clipPath="url(#clip0_40_53719)">
                <path
                  style={{ fill: category === "Fast Food" ? "white" : "black" }}
            ...
            <div>
              <h4
                style={{ color: category === "Fast Food" ? "white" : "black" }}
              >
                Fast food
              </h4>
              <p
          ...
          <div
            ...
            style={{
              backgroundColor:
                category === "Healthy Food" ? "#EA7E41" : "white",
            }}
          >
            <svg
              width="20"
            ...
            >
              <path
                style={{
                  fill: category === "Healthy Food" ? "white" : "black",
                }}
            ...
            <div>
              <h4
                style={{
                  color: category === "Healthy Food" ? "white" : "black",
                }}
              >
                Healthy food
              </h4>
