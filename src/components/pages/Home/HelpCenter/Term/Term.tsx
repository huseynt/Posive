...
const Term: React.FC<ITerm> = (props) => {
  ...
  return (
    ...
    <h2 className={style.parent_head}>{t("Term & Conditions")}</h2>
    ...
    <div className={style.parent_main}>
      <div className={style.parent_main_block}>
        <p className={style.parent_main_block_text}>{t("Welcome to our POS Dashboard! These terms and conditions outline the rules and regulations for the use of our POS Dashboard.")}</p>
        <p className={style.parent_main_block_text}>{t("By accessing this dashboard, we assume you accept these terms and conditions in full. Do not continue to use our POS Dashboard if you do not accept all of the terms and conditions stated on this page.")}</p>
      ...
      <div className={style.parent_main_block}>
        <h2 className={style.parent_main_block_head}>{t("Cookies")}</h2>
        <p className={style.parent_main_block_text}>{t("We employ the use of cookies. By using our POS Dashboard you consent to the use of cookies in accordance with our privacy policy.")}</p>
      </div>

      <div className={style.parent_main_block}>
        <h2 className={style.parent_main_block_head}>{t("License")}</h2>
        <p className={style.parent_main_block_text}>{t("Unless otherwise stated, we own the intellectual property rights for all material on our POS Dashboard. All intellectual property rights are reserved.")}</p>
      </div>

      <div className={style.parent_main_block}>
        <h2 className={style.parent_main_block_head}>{t("Restrictions")}</h2>
        <p className={style.parent_main_block_text}>{t("You are specifically restricted from all of the following :")}</p>
