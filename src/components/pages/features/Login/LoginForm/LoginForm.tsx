...
const LoginForm: React.FC<LoginFormProps> = (props) => {
  ...
  const { mutate: googleLogin, isPending: isGloginPending } = useMutation({
  ...
  return (
    <>
      ...
      {viewOpen === "privacy" && (
        <PrivacyForHomePage setViewOpen={setViewOpen} />
      )}
          ...
          <div className={style.login_form_email}>
            <input
              ...
              className={`${style.login_form_email_input} ${
                validate.email ? style.forWrongValidate : null
              }`}
              style={{
            ...
            {/* -- validation -- */}
            <div
              className={`${style.login_form_validation} ${
                validate.email && style.shake
              }`}
            >
              <span
                style={{
          ...
          <div className={style.login_form_password}>
            <input
              ...
              className={`${style.login_form_password_input} ${
                validate.password ? style.forWrongValidate : null
              }`}
              style={{
